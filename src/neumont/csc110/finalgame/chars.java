...
public class chars {
	...
	public void Character() throws IOException {
		...
		String[] chars = { "Mrs. Peacock - ", "Ms.sharon"+ "white" + "struve", "Mr. Green - cox",
				"Professor Plum - koehler", "Miss Scarlet - corinne", "Colonel Mustard - krebs" };

		ConsoleUI.promptForMenuSelection(chars, true);
